-- Graph RPC upgraded to use the explicit `title` column when
-- present, falling back to the first-line-of-content slice that
-- v1 used (so rows predating the title column stay rendered).
-- The rest of the CTE tree is unchanged.
