...
\titlegraphic{\hfill\includegraphics[height=1.4cm]{URV-logo.png}}
...
\begin{frame}{Dues parts, 9 objectius}
  \begin{columns}[T]
...
\begin{frame}{RAG de doble canal}
  \begin{columns}[c]
    \begin{column}{0.54\textwidth}
      \includegraphics[width=\textwidth, height=0.82\textheight, keepaspectratio]{rag-dual-channel.pdf}
    \end{column}
...
\begin{frame}{Decisions de disseny defensables}
  \begin{itemize}
    ...
    \item \textbf{Vercel Cron} per als agents: logica al mateix
