...
\begin{table}[H]
    ...
    \begin{tabular}{@{}lccl@{}}
        ...
        Setmana 4 (Agents) & 35 & --- & Pendent (decisió D5) \\
        Setmana 5 (Càrrega) & 30 & --- & Pendent \\
        Setmana 6 (Memoir) & 30 & --- & Pendent (en curs) \\
        Setmana 7 (Polit final) & 25 & --- & Pendent \\
        \midrule
        \textbf{Total estimat} & \textbf{610--650} & \textbf{$\approx$~600} & Cap a 5\% per sota del límit superior \\
        \bottomrule
    \end{tabular}
\end{table}
